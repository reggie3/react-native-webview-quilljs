...
},{}],"cKTC":[function(require,module,exports) {
"use strict";
...
},{"base64-js":"ZOQH","ieee754":"ajdM","isarray":"BzwP","buffer":"S4UE"}],"XWEk":[function(require,module,exports) {
var define;
...
},{"buffer":"S4UE"}],"CtUq":[function(require,module,exports) {
/**
...
},{}],"mdfe":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
module.exports = factory;
},{"object-assign":"J4Nk","fbjs/lib/emptyObject":"CtUq","fbjs/lib/invariant":"wRUG"}],"IAnx":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react":"n8MK","./factory":"mdfe"}],"F8fh":[function(require,module,exports) {
'use strict';
...
},{"quill":"XWEk"}],"s9iF":[function(require,module,exports) {
/**
...
},{"./_baseMatches":"s6cN","./_baseMatchesProperty":"zCYT","./identity":"Jpv1","./isArray":"p0cq","./property":"mWmH"}],"Sn5d":[function(require,module,exports) {
...
},{"./_createFind":"Sn5d","./findIndex":"cKQD"}],"oVe7":[function(require,module,exports) {
/**
...
},{"./_baseForOwn":"xqjy","./_createBaseEach":"Gl56"}],"uifF":[function(require,module,exports) {
...
},{"./_arraySome":"SfCF","./_baseIteratee":"lW7l","./_baseSome":"uifF","./isArray":"p0cq","./_isIterateeCall":"R62e"}],"R6wa":[function(require,module,exports) {
var baseIsEqual = require('./_baseIsEqual');
...
},{"./_baseIsEqual":"iKxp"}],"Asjh":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithThrowingShims":"wVGV"}],"SDKv":[function(require,module,exports) {
var define;
var global = arguments[3];
'use strict';
...
},{"react":"n8MK"}],"zt7h":[function(require,module,exports) {
'use strict';
...
},{"react":"n8MK","react-dom":"NKHc","create-react-class":"IAnx","./mixin":"F8fh","lodash/find":"y1nO","lodash/some":"cg6j","lodash/isEqual":"R6wa","prop-types":"D9Od","react-dom-factories":"SDKv"}],"KA3k":[function(require,module,exports) {
/** @license React v16.12.0
...
},{"./cjs/react-dom-server.browser.production.min.js":"KA3k"}],"r4F8":[function(require,module,exports) {
/*
...
},{"react":"n8MK","react-dom/server":"KpxE","create-react-class":"IAnx","lodash/find":"y1nO","lodash/isEqual":"R6wa","prop-types":"D9Od","react-dom-factories":"SDKv"}],"p7jG":[function(require,module,exports) {
/*
React-Quill v1.0.0
...
},{"quill":"XWEk","./component":"zt7h","./mixin":"F8fh","./toolbar":"r4F8"}],"tcXm":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.QuillComponentView = void 0;
...
// ES6
var QuillComponentView = function QuillComponentView(_a) {
  var _b = _a.addDebugMessage,
      addDebugMessage = _b === void 0 ? function () {} : _b,
      _c = _a.debugMessages,
      debugMessages = _c === void 0 ? [] : _c,
      content = _a.content,
      defaultValue = _a.defaultValue,
      _d = _a.isReadOnly,
      isReadOnly = _d === void 0 ? false : _d,
      _e = _a.modules,
      modules = _e === void 0 ? {} : _e,
      onChange = _a.onChange,
      onChangeSelection = _a.onChangeSelection,
      onFocus = _a.onFocus,
      onBlur = _a.onBlur,
      onKeyPress = _a.onKeyPress,
      onKeyDown = _a.onKeyDown,
      onKeyUp = _a.onKeyUp,
      onQuillRef = _a.onQuillRef,
      style = _a.style;

  var getModules = function getModules() {
    if (isReadOnly) {
      return __assign(__assign({}, modules), {
        toolbar: false
      });
    }
  ...
  return _react.default.createElement(_reactQuill.default, __assign({
    modules: getModules(),
    onChange: onChange,
...
exports.QuillComponentView = QuillComponentView;
var _default = QuillComponentView;
exports.default = _default;
},{"react":"n8MK","react-quill":"p7jG","react-quill/dist/quill.snow.css":"vKFU"}],"UEuB":[function(require,module,exports) {
"use strict";
...
exports.MessageInstruction = void 0;

var _quill = require("quill");

var MessageInstruction;
exports.MessageInstruction = MessageInstruction;
...
})(MessageInstruction || (exports.MessageInstruction = MessageInstruction = {}));
},{"quill":"XWEk"}],"eO6J":[function(require,module,exports) {
var define;
/*!
...
},{}],"R3IB":[function(require,module,exports) {
...
},{}],"IrhR":[function(require,module,exports) {
...
},{"process":"R3IB"}],"HMCB":[function(require,module,exports) {
"use strict";
...
var _typeof2 = _interopRequireDefault(require("C:\\Users\\regin\\Dropbox\\react-native-webview-quilljs\\htmlString\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/typeof"));

var _react = _interopRequireDefault(require("react"));

require("react-quill/dist/quill.snow.css");

var _QuillComponent = _interopRequireDefault(require("./QuillComponent.view"));
...
function (_super) {
  ...
  function QuillComponent(props) {
    ...
    _this.componentDidMount = function () {
      _this.setState({
        ...
        try {
          _this.sendMessage({
            instruction: _models.MessageInstruction.QUILL_READY
          });
        } catch (error) {
        ...
        if (document) {
          ...
          _this.sendMessage({
            instruction: _models.MessageInstruction.DOCUMENT_EVENT_LISTENER_ADDED
          });
        }
        ...
        if (window) {
          ...
          _this.sendMessage({
            instruction: _models.MessageInstruction.WINDOW_EVENT_LISTENER_ADDED
          });
        }
    ...
    _this.componentDidUpdate = function (prevProps, prevState) {
      var _a = _this.state,
          ...
          isDesktopBrowser = _a.isDesktopBrowser;

      if (debugMessages !== prevState.debugMessages) {
        console.log(debugMessages);
      }

      if (!(0, _lodash.default)(browser, prevState.browser)) {
        _this.setState({
          isDesktopBrowser: _this.isDesktopBrowser()
        }, function () {
    ...
    _this.onQuillRef = function (ref) {
      var isReadOnly = _this.state.isReadOnly;

      if (_this.quillRef === null) {
        _this.quillRef = ref;

        if (!isReadOnly) {
          _this.setQuillContainerHeight(_this.quillRef);
        }
      }
    }; // adjust the height of the editor container if there is a toolbar added


    _this.setQuillContainerHeight = function (quillRef) {
      try {
        // want to switch this to optional chaining at some point
        var toolbarHeight = quillRef.editor.theme.modules.toolbar.container.clientHeight;
        var res = (0, _sizzle.default)(".ql-container");
        var htmlElement = res[0];

        if (htmlElement.style) {
          // the extra subtracted pixel is to make the editor component cleaner looking
          htmlElement.style.height = Math.floor(_this.state.height - toolbarHeight - 1) + "px";
        }
      } catch (error) {
        _this.addDebugMessage(error);
      }
    ...
    _this.componentWillUnmount = function () {
      if (document) {
        ...
        _this.sendMessage({
          instruction: _models.MessageInstruction.DOCUMENT_EVENT_LISTENER_REMOVED
        });
      }
      ...
      if (window) {
        ...
        _this.sendMessage({
          instruction: _models.MessageInstruction.WINDOW_EVENT_LISTENER_REMOVED
        });
      }
    };
    ...
    _this.onChange = function (html, delta, source, editor) {
      editor.getContents();

      _this.sendMessage({
        instruction: _models.MessageInstruction.CONTENT_CHANGED,
        payload: {
          html: editor.getHTML(),
    ...
    _this.onChangeSelection = function (range, source, editor) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_CHANGE_SELECTION,
        payload: {
          range: range,
    ...
    _this.onFocus = function (range, source, editor) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_FOCUS,
        payload: {
          range: range,
          source: source,
          editor: editor
    ...
    _this.onBlur = function (previousRange, source, editor) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_BLUR,
        payload: {
    ...
    _this.onKeyPress = function (event) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_KEY_PRESS,
        payload: {
          event: event
        }
      });
    ...
    _this.onKeyDown = function (event) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_KEY_DOWN,
        payload: {
          event: event
        }
      });
    ...
    _this.onKeyUp = function (event) {
      _this.sendMessage({
        instruction: _models.MessageInstruction.ON_KEY_UP,
        payload: {
          event: event
        }
      });
    ...
    _this.shouldRenderQuillComponentView = function () {
      var isReadOnly = _this.state.isReadOnly;

      var isDesktopBrowser = _this.isDesktopBrowser();

      return isReadOnly !== null || isDesktopBrowser;
    };

    _this.isDesktopBrowser = function () {
      var desktopOSNames = ["windows"];
      return !!desktopOSNames.find(function (OS) {
        var _a, _b;

        var isBrowser = (_b = (_a = _this.state.browser) === null || _a === void 0 ? void 0 : _a.os) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(OS);
        return isBrowser;
      });
    };
  ...
  QuillComponent.prototype.render = function () {
    var _a = this.state,
        ...
        debugMessages = _a.debugMessages,
        defaultValue = _a.defaultValue,
        doShowQuillComponentDebugMessages = _a.doShowQuillComponentDebugMessages,
        height = _a.height,
        isReadOnly = _a.isReadOnly,
        toolbarHeight = _a.toolbarHeight;
    return _react.default.createElement(_react.default.Fragment, null, this.shouldRenderQuillComponentView() && // @ts-ignore
    _react.default.createElement(_QuillComponent.default, {
    ...
    }), doShowQuillComponentDebugMessages && _react.default.createElement("div", {
      style: {
      ...
      id: "messages"
    }, _react.default.createElement("ul", null, debugMessages.map(function (message, index) {
...
var _default = QuillComponent;
exports.default = _default;
},{"C:\\Users\\regin\\Dropbox\\react-native-webview-quilljs\\htmlString\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/typeof":"cKTC","react":"n8MK","react-quill/dist/quill.snow.css":"vKFU","./QuillComponent.view":"tcXm","./models":"UEuB","sizzle":"eO6J","lodash.isequal":"a1XM","detect-browser":"IrhR"}],"Focm":[function(require,module,exports) {
"use strict";
...
var _QuillComponent = _interopRequireDefault(require("./QuillComponent"));
...
//# sourceMappingURL=src.f0ddc2ac.js.map